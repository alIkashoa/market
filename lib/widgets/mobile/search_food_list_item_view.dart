...
onTap: (){
              ...
              Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => profile(food.usr),
                          ),
                        );
...
class SearchFoodListItemView2 extends StatelessWidget {
  const SearchFoodListItemView2({
    Key? key,
    required this.food,
  }) : super(key: key);
...
onTap: (){
              ...
              Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => FoodProfile(food.usr),
                          ),
                        );
